...
import { deleteBlogAction, listBlogs } from '../../actions/blog.js'
...
export default function MyProfile() {
  ...
  const { success: successDelete } = deleteBlog
    ...
    <div className='mx-auto max-w-7xl px-4 sm:px-6 pt-6'>
      <div className='overflow-hidden bg-white shadow sm:rounded-lg'>
        <div className='px-4 py-5 sm:px-6'>
          <center>
            <img className='h-40 w-55 rounded-lg object-cover object-center' src={`http://127.0.0.1:8000${userInfo.image}`} alt='' />
                    ...
                    <div className='w-full'>
                      <div key={blog.id} className='flex justify-between items-center m-8'>
                        <div className='flex flex-row items-center'>
                          <img src={`http://127.0.0.1:8000${userInfo.image}`} className='rounded-lg object-cover object-center' width='40' />
