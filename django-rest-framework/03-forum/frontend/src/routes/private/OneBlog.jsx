...
import { blogActionDetails, createBlogComment } from '../../actions/blog.js'
import { getListUsers } from '../../actions/user.js'
import Loader from '../../components/Loader'
import Messages from '../../components/Messages'
import { BLOG_CREATE_COMMENT_RESET } from '../../constants/blog.js'
                            ...
                            <div key={user.id}>
                              {user.user_name === blog.user && (
                                <div className='flex flex-row items-center ml-2'>
                                  ...
                                  <a style={{ textDecoration: 'none' }} href={`/user-profile/${user.id}`} className='text-blue-600 text-sm hover:text-blue-800'>
                                    See Profile
                                  </a>
                                </div>
                              )}
