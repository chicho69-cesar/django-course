          ...
          {userInfo ? (
            <>
              <Popover.Group as='nav' className='hidden space-x-10 md:flex'>
                ...
                <a href='/add-blog' className='text-base font-medium text-gray-500 hover:text-gray-900'>
              ...
              {userInfo ? (
                <>
                  <div className='grid grid-cols-3 gap-y-4 gap-x-8'>
                    ...
                    <a href='/add-blog' className='text-base font-medium text-gray-900 hover:text-gray-700'>
                      <AiFillPlusSquare size={30} />
                    </a>
